            ...
            <CCol sm="12">
              <div class="d-flex justify-content-center">
                <CButton
                  ...
                  class="mt-3 mx-2"
                  :disabled="isLoading"
                  v-on:click.prevent="editSubCategory()"
                >
                  Confirm
                </CButton>
...
export default {
  ...
  methods: {
    ...
    ...mapActions({ updateSubCategoryId: "updateSubCategoryId" }),
    editSubCategory() {
      ...
      if (this.categoryByID.name === "") {
        ...
        this.updateSubCategoryId(formData);
