...
export const buildCongratulationsRegisterStoreSuccess = () => {
  const subjectSuccess = 'REGISTER SUCCESSFULLY';
  const textSuccess = 'FLASH BUY';
  const htmlSuccess = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
    <html
      data-editor-version="2"
      class="sg-campaigns"
      xmlns="http://www.w3.org/1999/xhtml"
                                                            ...
                                                            >
                                                              ...
                                                              >
                                                                <span
                                                                  ...
                                                                  ><em
                                                                  style="line-height= 1"
                                                                    >you have successfully registered and now you are also the manager of the store.
                                                                  </em></span
                                                                >
                                                              </div>
                                                            </div>
    ...
    `;
  return { htmlSuccess, subjectSuccess, textSuccess };
};
